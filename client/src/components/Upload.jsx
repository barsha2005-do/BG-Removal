  ...
  return (
    <div className='pb-16 '>
        ...
        <div className='text-center mb-24'>
                ...
                <label className='inline-flex gap-3 px-6 py-2 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700' htmlFor="upload2">
